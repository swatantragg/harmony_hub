...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  'asset:edit': 'Edit details and tags',
  'asset:rename': 'Rename files',
  'asset:delete': 'Move files to the recycle bin',
  'asset:purge': 'Destroy files permanently',
  'asset:rekey': 'Move a stored object',
  'asset:restore': 'Request archive restores',
  'catalogue:edit': 'Create and edit artists and songs',
  'share:create': 'Create external share links',
  'share:revoke': 'Revoke share links',
  'admin:storage': 'See storage health and fix drift',
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <button className="btn btn-primary" disabled={!name || !email || create.isPending} onClick={() => create.mutate()}>Create account</button>
        </>
      }
    >

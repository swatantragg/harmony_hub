      ...
      <div className="stack-4">
        ...
        <div className="row" style={{ gap: 12, alignItems: 'flex-start', flexWrap: 'wrap' }}>
          <FolderPicker
            ...
            hint="Move this file into a folder, or take it out. Either way the stored object stays exactly where it is."
          />
        </div>
        ...
        {folderChanged && (
          <div className="note indigo">
            <Info size={15} />
            <div>
              <b>This only changes the grouping.</b> The object key stays{' '}
              <span className="keytext">{asset.s3.key}</span> — no bytes move, and every share
              link keeps working.
            </div>
          </div>
        )}

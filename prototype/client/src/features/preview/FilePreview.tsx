...
//
// Every byte here arrives over a presigned inline URL fetched directly from storage. The
...
// Everything below fetches its own bytes. The presigned URL is the same one the <img> or
